      ...
      {renderTopicMaterialPanel ? (
        <section className="topic-material-panel" style={{ marginTop: "0.5rem" }}>
          <div className="range-head">
            ...
            <p>Processing uses only the topic content saved here. Full source is allowed only when you click Use Full Source.</p>
            <p className="transcript-note" style={{ margin: "0.35rem 0 0" }}>
              Saved topics are restored when you reopen a project.
            </p>
          </div>
