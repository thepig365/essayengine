    ...
    return (
      <>
        ...
        <details className="layer ps-settings-details">
          ...
          <div className="writing-hint">
            For Chinese lyrical prose, use “Modern Chinese lyrical prose”. It asks for a quiet, restrained, delicate modern Chinese essay tone without directly imitating any
            specific writer.
          </div>
        </details>
