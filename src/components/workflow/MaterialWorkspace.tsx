    ...
    return (
      <section className="layer source-input-layer">
        <div className="layer-head">
          ...
          <p>Use this area only for raw material and links, not writing instructions. Supports YouTube, podcast pages, LinkedIn, social or forum links, and long-form paste.</p>
        </div>
      ...
      <>
        ...
        <section className="layer source-layer">
          ...
          <div className="input-label">
            Engine source (confirmed text sent to Generate) — select material in Extract, then replace Source Capture or refine the confirmed text here.
          </div>
