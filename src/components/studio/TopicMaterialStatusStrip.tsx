      ...
      <div className="ee-topic-strip-main">
        ...
        {variant === "missing" ? (
          ...
          <>
            ...
            <span className="ee-topic-meta">
              Mode: {fullSourceAvailable ? "Full source" : "Selected source"}
            </span>
          </>
        )}
      </div>
      {variant === "stale" ? (
        <p className="ee-topic-stale-msg">Topic may be stale: the source changed after this topic was saved. Save the topic again.</p>
      ) : null}
