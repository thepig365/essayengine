  ...
  return (
    ...
    >
      <div className="layer-head">
        ...
        <p>Every source becomes selectable text blocks first. By default, the full source is not used.</p>
      </div>
      ...
      <label className="organize-option" style={{ marginTop: "0.75rem" }}>
        ...
        <span>Use Full Source (only when explicitly checked)</span>
      </label>
      <p className="transcript-note">
        When unchecked, analysis, custom extraction, and the saved topic use only selected chapters or paragraph blocks. To use an entire video or full text, check this option or use the full-source action below.
      </p>

      {sourceMaterialPipeline === "link" && (
        <div className="topic-filter" style={{ marginTop: "1rem" }}>
          <div className="range-head">
            <strong>Link extraction (LinkedIn / social / forums / podcast pages)</strong>
        ...
        <div className="topic-filter" style={{ marginTop: "1rem" }}>
          ...
          <label className="field">
            ...
            <textarea
              ...
              placeholder="Paste an article, notes, thread, transcript, or long-form text…"
            />
          </label>
          <div className="range-actions cta-row">
      ...
      {sourceMaterialPipeline === "document" && (
        <div className="topic-filter" style={{ marginTop: "1rem" }}>
          <div className="range-head">
            ...
            <p>Supports .txt, .md, .srt, and .vtt. Timestamped files appear as timed blocks.</p>
          </div>
          <label className="field">
            <span>File</span>
            <input
      ...
      {genericSegments.length > 0 && sourceMaterialPipeline !== "transcript" && (
        <div className="section-workspace" style={{ marginTop: "1rem" }}>
          <div className="range-head">
            ...
            <p>Select the blocks to use for analysis and writing. Forum/thread structure is preserved when possible.</p>
          </div>
      ...
      <details open className="priority-section" style={{ marginTop: "1rem" }}>
        ...
        <div className="timestamp-chapters">
          ...
          {selectedMaterial ? (
            ...
            <p className="transcript-note">No usable source selection yet. Select chapters/paragraphs, or choose Use Full Source.</p>
          )}
      ...
      <details open className="priority-section" style={{ marginTop: "0.5rem" }}>
        <summary>Analyze Source (selected only)</summary>
        <div className="timestamp-chapters">
          <p className="transcript-note">These actions use only selected topic text and never default to the full source.</p>
          <div className="range-actions cta-row ee-quick-action-grid">
          ...
          <label className="field">
            ...
            <textarea
              ...
              placeholder="Example: Find the most useful sections for a reflective article, or extract the main claims from this podcast transcript…"
            />
          </label>
          <div className="range-actions cta-row">
            <button
        ...
        <div className="transcript-empty">
          ...
          <p>
            {effectiveYoutubeSource
              ? "Extract the source, then use timestamp chapters, rough sections, or topic filters before saving to Source."
              : "Paste a YouTube link in Source and return here, or use Link Extract, Paste Long Text, or Upload Audio for other sources."}
          </p>
          {effectiveYoutubeSource && (
