    ...
    return (
      <section className="layer source-input-layer">
        <div className="layer-head">
          ...
          <p>This step is only for source material and links, not writing instructions. Use YouTube, podcast pages, LinkedIn, social posts, forum links, articles, or pasted long-form text.</p>
        </div>
      ...
      <>
        ...
        <section className="layer source-layer">
          ...
          <div className="input-label">
            Engine source (confirmed text sent to Generate) — finish extraction first, then replace Source with your selection or fine-tune the confirmed text here.
          </div>
            ...
            <div className="transcript-box source-fetch">
              <div>
                ...
                <ol className="source-fetch-flow">
                  ...
                  <li>Optional: use Listen to Source when your audio tools are open in Review or the audio panel.</li>
                </ol>
