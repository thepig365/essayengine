      ...
      {renderTopicMaterialPanel ? (
        <section className="topic-material-panel" style={{ marginTop: "0.5rem" }}>
          <div className="range-head">
            <strong>Selected topic source</strong>
            <p>Processing only uses the topic content saved here. Full source text is allowed only after you click “Use Full Source.”</p>
          ...
          {topicMaterial ? (
            <div className="topic-material-preview">
              {isCurrentTopicStale && <span className="range-status">Topic may be stale: the source changed after this topic was saved. Save the topic again.</span>}
            ...
            <p className="transcript-note">No topic saved yet. Select source material, then click “Save as Topic.”</p>
          )}
        </section>
      ) : null}
      {children}
